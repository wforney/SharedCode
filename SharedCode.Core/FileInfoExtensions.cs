...
namespace SharedCode.Core
{
    ...
    public static class FileInfoExtensions
    {
        ...
        ///     The <paramref name="destFileName">destFileName</paramref> is read-only or is
        ///     a directory.
        /// </exception>
        /// <exception cref="ArgumentNullException"><paramref name="destFileName">destFileName</paramref> is null.</exception>
        ...
        ///     The <paramref name="destFileName">destFileName</paramref> contains a colon (:) in
        ///     the middle of the string.
        /// </exception>
        public static void MoveTo(
            [NotNull] this FileInfo fileInfo,
            [NotNull] string destFileName,
            bool renameWhenExists = false)
        {
